  ...
  return useMutation({
    mutationFn: async (episodeId: string) => {
      ...
      if (!response.ok) {
        ...
        throw new Error('Failed to increment episode views');
      }
      return response.json();
    },
  ...
  return useMutation({
    mutationFn: async (episodeId: string) => {
      ...
      if (!response.ok) {
        ...
        throw new Error('Failed to increment show episode views');
      }
      return response.json();
    },
    onSuccess: (data, episodeId) => {
      ...
      console.log('Show episode view incremented successfully');
    },
    onError: (error) => {
